...
- (void)setupScrollView{
    ...
    for (UIImage *movie in self.movies) {
...
- (void)adjustSubviews:(UIScrollView *)scrollView{
    ...
    if (self.movies.count > 0) {
        ...
        if (scale < 0.0) {
            ...
            leftView.layer.borderColor = [UIColor colorWithWhite:0.3 alpha:scale].CGColor;
            ...
            if (index + 1 >= self.movies.count) {
                ...
                imgView.layer.borderColor = [UIColor colorWithWhite:0.3 alpha:scale].CGColor;
                height = kItemHeight + (kItemSelectedHeight - kItemHeight) * scale;
                width = kItemWidth + (kItemSelectedWidth - kItemWidth) * scale;
                ...
                UIImageView *leftView = self.items[index];
                leftView.layer.borderColor = [UIColor colorWithWhite:0.3 alpha:scaleLeft].CGColor;
