...
- (void)setupView {
    ...
    // UIButtons.
    [self.leftButton setBackgroundColor:[UIColor colorWithWhite:0.959 alpha:0.200]];
    [self.rightButton setBackgroundColor:[UIColor colorWithWhite:0.959 alpha:0.200]];
