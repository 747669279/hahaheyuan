...
-(void)addAlertView1{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"密码修改失败" message:@"请确认你的验证码是否输入正确!!!" preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *action1 = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NSLog(@"密码修改失败!!!");
    }];
    [alertController addAction:action1];
...
-(void)addAlertView6{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"获取验证码失败" message:@"请检查你的手机号码是否输入正确!!!" preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *action1 = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NSLog(@"手机号码不正确!!!");
    }];
    [alertController addAction:action1];
